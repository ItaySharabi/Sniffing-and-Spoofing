...
int main(){
	...
	char filter_exp[] = "icmp and (src host 10.0.2.4 and dst host 10.0.2.5) or (dst host 10.0.2.4 and src host 10.0.2.5)";
	bpf_u_int32 net;
...
// Step 3: Capture packets
	...
	printf("Sniffing ICMP between 10.0.2.5 and 10.0.2.4...\n");
